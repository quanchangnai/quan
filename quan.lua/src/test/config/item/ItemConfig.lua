...
---所有ItemConfig
local configs = {
    { id = 1, key = "item1", name = "道具1", type = 1, reward = { itemId = 3, itemNum = 10 }, list = { 11, 112, 322 }, set = { 465, 554, 655, 233 }, map = { [122] = 2, [322] = 22, [455] = 33 }, effectiveTime = 1564979635, effectiveTime_Str = "2019.08.05 12.33.55" },
    { id = 2, key = "item2", name = "道具2", type = 1, reward = { itemId = 2, itemNum = 2 }, list = { 56, 22, 21 }, set = { 244 }, map = { }, effectiveTime = 0, effectiveTime_Str = "" },
    { id = 2, key = "", name = "道具3", type = 2, reward = { itemId = 2, itemNum = 11 }, list = { 44, 223, 342, 45 }, set = {  }, map = { [43] = 45 }, effectiveTime = 0, effectiveTime_Str = "" },
}
