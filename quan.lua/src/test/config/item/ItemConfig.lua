...
local configs = {
    ...
    { id = 10, key = "", name = "道具10", type = 1, useEffect = { class = "UseEffect", aaa = 123 }, reward = { itemId = 3, itemNum = 10 }, list = { 11, 112, 322 }, set = { 465, 554, 655, 233 }, map = { }, effectiveTime = 1564979635000, effectiveTime_ = "2019-08-05 12:33:55" },
