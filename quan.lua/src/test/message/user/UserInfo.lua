---
---用户信息
---Generated by LuaMessageGenerator
---
...
function UserInfo:encode(buffer)
    ...
    buffer:writeTag(19)
    local roleInfo1Buffer = Buffer.new()
    ...
    buffer:writeTag(31)
    local roleSetBuffer = Buffer.new()
    ...
    buffer:writeTag(35)
    local roleMapBuffer = Buffer.new()
