...
import static quan.common.utils.CollectionUtils.asSet;
...
public final class Constants {
     ...
     * 原生类型
     */
    public static final Set<String> PRIMITIVE_TYPES = CollectionUtils.asSet(NUMBER_TYPES, "bool", "string");

    /**
     * 集合类型
     */
    public static final Set<String> COLLECTION_TYPES = CollectionUtils.asSet("list", "set", "map");

    /**
     * 时间类型
     */
    public static final Set<String> TIME_TYPES = CollectionUtils.asSet("date", "time", "datetime");
     ...
     * 配置支持的合法分隔符
     */
    public static final Set<String> LEGAL_DELIMITERS = CollectionUtils.asSet(";", ":", "_", "*", "|", "$", "@", "&", "?");

    /**
     * 配置支持的需要转义的分隔符(正则表达式特殊字符)
     */
    public static final Set<String> NEED_ESCAPE_DELIMITERS = CollectionUtils.asSet("*", "|", "?");
