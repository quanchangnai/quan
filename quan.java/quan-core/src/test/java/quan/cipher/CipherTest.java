...
public class CipherTest {
    ...
    public void testSymmetricEncrypt1() {
        for (SymmetricCipher.Algorithm algorithm : SymmetricCipher.Algorithm.values()) {
    ...
    public void testAsymmetricEncrypt1() {
        ...
        AsymmetricCipher asymmetricCipher = new AsymmetricCipher(AsymmetricCipher.Algorithm.RSA);
    ...
    public void testAsymmetricEncrypt2() {
        ...
        AsymmetricCipher asymmetricCipher = new AsymmetricCipher(AsymmetricCipher.Algorithm.RSA, publicKey, privateKey);
    ...
    public void testAsymmetricSign2() {
        ...
        AsymmetricCipher asymmetricCipher = new AsymmetricCipher(AsymmetricCipher.Algorithm.DSA, publicKey, privateKey);
